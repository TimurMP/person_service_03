...
import telran.java2022.person.dto.*;
...
//		personRepository.save(person);
	...
	public void run(String... args) throws Exception {
		Person person = new Person(1000, "John", LocalDate.of(1985, 4, 11),
				new Address("Tel Aviv", "Hashalom", 5));

		Child child = new Child(2000, "Mike", LocalDate.of(2015, 4, 11),
				new Address("Tel Aviv", "Hashalom", 5), "aaa");

		Employee employee = new Employee(3000, "Tim", LocalDate.of(1988, 2, 16),
				new Address("Tel Aviv", "Hashalom", 5), "CHKP", 200000);
